...
import { size } from '@/app/share/[id]/opengraph-image'
...
function IconGmail({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      role="img"
      viewBox="0 0 30 30"
